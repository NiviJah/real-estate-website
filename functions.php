...
function _tk_scripts() {
	...
	wp_enqueue_style( '_tk-bootstrap', get_template_directory_uri() . '/includes/resources/bootstrap/css/bootstrap.min.css' );
		// load bootstrap css
	wp_enqueue_style( 'slider', get_template_directory_uri() . '/includes/css/lightSlider.css' );
	...
	wp_enqueue_script( '_tk-skip-link-focus-fix', get_template_directory_uri() . '/includes/js/skip-link-focus-fix.js', array(), '20130115', true );
		...
		wp_enqueue_script( 'sliderjs', get_template_directory_uri() . '/includes/js/jquery.lightSlider.min.js', array(), '20130115', true );
...
function properties_custom_post_type() {
	...
	$labels = array(
		'name'                => _x( 'properties', 'Post Type General Name', 'property' ),
		'singular_name'       => _x( 'property', 'Post Type Singular Name', 'property' ),
		'menu_name'           => __( 'properties', 'property' ),
		'parent_item_colon'   => __( 'Parent Item:', 'property' ),
		'all_items'           => __( 'All properties', 'property' ),
		'view_item'           => __( 'View Item', 'property' ),
		'add_new_item'        => __( 'Add property', 'property' ),
		'add_new'             => __( 'Add property', 'property' ),
	...
	$args = array(
		'label'               => __( 'property', 'property' ),
		'description'         => __( 'properties', 'property' ),
		'labels'              => $labels,
...
add_action( 'init', 'properties_custom_post_type', 0 );
